...
define('SKTTHEMES_URL','https://www.sktthemes.org');
define('SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/education-wordpress-theme/');
define('SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-education-wordpress-theme/');
define('SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/playschool-documentation/');
define('SKTTHEMES_LIVE_DEMO','http://sktthemesdemo.net/school/');
define('SKTTHEMES_THEMES','https://www.sktthemes.org/themes/');
...
add_action( 'tgmpa_register', 'play_school_register_required_plugins' );
 
function play_school_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
